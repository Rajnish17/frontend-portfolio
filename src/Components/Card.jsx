...
<div className="card-group">
  ...
  <div className="card">
    <img src="https://cdn.pixabay.com/photo/2016/11/06/17/17/north-america-1803504_640.jpg" className="card-img-top" alt="..." />
    <div className="card-body">
      <h5 className="card-title">Visit Canada</h5>
      <p className="card-text">
  ...
  <div className="card">
    <img src="https://a.cdn-hotels.com/gdcs/production133/d1829/743b2f60-bb25-11e8-a095-0242ac11000d.jpg" className="card-img-top" alt="..." />
    <div className="card-body">
      <h5 className="card-title">Visit Germany</h5>
      <p className="card-text">
        This is a wider card with supporting text below as a natural lead-in to
